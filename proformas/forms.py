...
from .models import Brand, Client, Family, Item, ProformaLine, Site, SubFamily, TubingLength
from .services import validate_internal_code
...
class ItemForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {"sub_family": DataDefaultSelect}
